...
const MadrasaSubjectSchema = new mongoose.Schema({
...
MadrasaSubjectSchema.index({ tenant_id: 1, madrasa_id: 1, class_id: 1 });

module.exports = mongoose.model('MadrasaSubject', MadrasaSubjectSchema);
